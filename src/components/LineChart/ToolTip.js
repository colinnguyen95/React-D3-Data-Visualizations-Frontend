    ...
    render(){
        ...
        return (
            <g transform={transform}>
                <rect className="shadow" is width={width} height={height} rx="5" ry="5" visibility={visibility} fill="#6391da" opacity=".9"/>
                ...
                <text is visibility={visibility} transform={transformText}>
                    ...
                    <tspan is x="0" textAnchor="middle" dy="25" fontSize="20px" fill="#a9f3ff">{this.props.tooltip.data.value+" visits"}</tspan>
                </text>
            </g>
        );
    }
